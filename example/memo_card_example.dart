...
void main() {
  ...
  MemoCard level1MemoCard = MemoCard(knowledge: knowledgeTree['firstLevel']);
  MemoCard level2MemoCard = MemoCard(knowledge: knowledgeTree['secondLevel']);
  MemoCard level3MemoCard = MemoCard(knowledge: knowledgeTree['thirdLevel']);
