...
/// A class that represents a memorization card containing node 
...
class MemoCard {
  ...
  /// Initialization of a new MemoCard with the given [node].
  MemoCard(this._node);

  /// Rates the card node and updates its state and review log.
  ...
  @override
  String toString() {
    return 'Memorization Card for node: $_node; with state: $state and due at: $due.';
  }
}
